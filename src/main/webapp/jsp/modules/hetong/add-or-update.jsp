                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>合同文件</label>
                                        <input name="file" type="file" class="form-control-file" id="wenjianFileupload">
                                        <label id="wenjianFileName"></label>
                                        <input name="wenjianFile" id="wenjianFile-input" type="hidden">
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>签署人</label>
...
<script>
    ...
    // 文件上传
    function upload() {
        $('#wenjianFileupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                document.getElementById('wenjianFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
    ...
    function dataBind() {
        ...
        $("#wenjianFile").val(ruleForm.wenjianFile);
